...
'category.index','category.store','category.show','category.update','category.destroy','product.index','product.store','product.show','product.update',
'product.destroy','offer.index','offer.store','offer.show','offer.update',
'offer.destroy','customer.index','customer.store','customer.show',
'customer.update','customer.destroy','employee.index','employee.store','employee.show',
'employee.update','employee.destroy','sales-representative.index','sales-representative.store','sales-representative.show',
'sales-representative.update','sales-representative.destroy','delevery-man.index','delevery-man.store','delevery-man.show',
'delevery-man.update','delevery-man.destroy','attendance.index','attendance.store','attendance.show',
'attendance.update','attendance.destroy',
